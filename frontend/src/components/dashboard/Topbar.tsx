    ...
    <header className="h-16 bg-white/90 border-b border-slate-200/80 flex items-center justify-between px-4 sm:px-6 lg:px-8 sticky top-0 z-20 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        <button
          ...
          aria-label="Logout"
        >
          <LogOut className="w-4.5 h-4.5 text-slate-400 group-hover:text-slate-900 transition-colors" />
        </button>
        ...
        <div className="flex items-center gap-4">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[10px] text-indigo-600 font-black uppercase tracking-[0.2em] mt-1.5 opacity-80">Connected Workspace</p>
          </div>
