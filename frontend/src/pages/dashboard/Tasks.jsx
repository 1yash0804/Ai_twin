...
export default function Tasks() {
    ...
    const [tasks, setTasks] = useState([
        { id: 1, title: 'Team meeting @ 2pm today', completed: false, dueDate: 'Today', priority: 'high', source: 'Work Group' },
        { id: 2, title: 'Coffee with Sarah @ 3pm tomorrow', completed: false, dueDate: 'Tomorrow', priority: 'medium', source: 'Sarah' },
        { id: 3, title: 'Call Mike this weekend', completed: false, dueDate: 'This Weekend', priority: 'low', source: 'Mike' },
        { id: 4, title: 'Review presentation slides', completed: true, dueDate: 'Yesterday', priority: 'medium', source: 'Manual' },
        { id: 5, title: 'Buy groceries', completed: false, dueDate: 'No date', priority: 'low', source: 'Manual' }
    ]);
