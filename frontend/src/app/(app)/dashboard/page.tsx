        ...
        <div className="p-10 space-y-16 bg-slate-50/50 min-h-full">
            <FadeUp>
                <div className="space-y-2">
                    <h1 className="text-4xl font-bold text-slate-900 tracking-tight">Operational Snapshot</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {stats.map((stat, i) => (
                    <FadeUp key={i} delay={i * 0.08}>
                        <div className={`bg-white border ${stat.border} p-8 rounded-[2.5rem] group hover:border-indigo-600/40 transition-all duration-500 shadow-sm hover:shadow-xl hover:shadow-indigo-600/5 relative overflow-hidden`}>
                            ...
                            <p className="text-4xl font-bold text-slate-900 mt-2 relative z-10">{stat.value}</p>
                        </div>
                    </FadeUp>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 pt-4">
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-sm shadow-slate-200/50 divide-y divide-slate-100">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="p-8 hover:bg-slate-50 transition-colors flex items-center justify-between group cursor-pointer">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white border-2 border-indigo-600 p-10 rounded-[3rem] text-slate-900 shadow-2xl shadow-indigo-600/10 relative overflow-hidden group">
                        ...
                        <p className="text-3xl font-bold tracking-tight mb-10 leading-tight">472 messages processed today.</p>
